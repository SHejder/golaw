<section class="search-criteria-sect">
        ...
        <div class="search-criteria">
            <div class="search-criteria__wrap-filters">
                ...
                <button style="display: none;" class="search-criteria__clear s-clr"><?php trans('Clear all filters'); ?></button>
            </div>
            <div class="search-criteria__maches">
                <span class="search-criteria__count"><?= $wp_query->found_posts; ?></span>
